...
.login-button:hover {
  ...
  <body>
    <div class="login">
      <a href="agentlogin.php"><button class="login-button">Agent Login</button></a>
      <button class="login-button">Seller Login</button>
      <button class="login-button">Buyer Login</button>
    </div>
    <div class="container">
      <div class="header">
    ...
    if(isset($_POST['location']) || isset($_POST['price-range']) || isset($_POST['bedrooms'])){
        ...
        $query = "SELECT p.* FROM properties p JOIN listings l ON p.id = l.property_id WHERE 1=1";
